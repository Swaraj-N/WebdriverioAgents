...
exports.config = {
  ...
  Pixel_2_V8 */
    ...
    beforeTest: async function () {
        // await configureIPScreen.configureIP(testData.ipAddress.publicIP2)
    },
    /**
    ...
    afterTest: async function (test, context, { error }) {
        ...
        // await Profilescreen.logoutOfApp()
    },
    ...
    onComplete: function () {
        ...
        return new Promise((resolve, reject) => {
            ...
            generation.on('exit', function (exitCode) {
                ...
                // Rename the generated single-file HTML report to include the formatted timestamp
